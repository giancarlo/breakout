...
;
	...
	extend(Mice.prototype, {
		...
		destroy: function()
		{
			element.removeEventListener('click', this._click.bindfn);
			element.removeEventListener('mousemove', this._mousemove.bindfn);
			// Touch Event
			element.removeEventListener('touchmove', this._mousemove.bindfn);
		}
